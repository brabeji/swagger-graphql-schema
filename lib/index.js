							...
							args = operation.parameters.reduce(function (acc, parameter) {
								...
								if (!argPath) {
									...
									if ((paramIn === 'body' || paramIn === 'formData') && paramSchema) {
										_type = typesCache[paramSchema.$$rootInputType];
									}
									if (!_type) {
...
var constructInputType = function constructInputType(_ref4) {
	var schema = _ref4.schema,
	    inputTypeName = _ref4.typeName,
	    typesCache = _ref4.typesCache,
	    _ref4$isNestedUnderEn = _ref4.isNestedUnderEntity,
	    isNestedUnderEntity = _ref4$isNestedUnderEn === undefined ? false : _ref4$isNestedUnderEn,
	...
	if ((0, _lodash.isArray)(schema.anyOf)) {
		inputType = new _graphqlUnionInputType2.default({
			name: typeName,
			types: schema.anyOf.map(function (unionPartSchema) {
	...
	if (!inputType) {
		...
		var a = Object.keys(properties).filter(function (k) {
...
var parseRootInputTypes = function parseRootInputTypes(_ref5) {
	var rootSchema = _ref5.schema,
	    typesCache = _ref5.types,
...
var parseUnions = function parseUnions(_ref6) {
...
var parseLists = function parseLists(_ref7) {
...
var swaggerToSchema = function swaggerToSchema() {
	var _ref8 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	    paths = _ref8.swagger.paths,
	    swagger = _ref8.swagger,
	    createResolver = _ref8.createResolver,
	    _ref8$discriminatorFi = _ref8.discriminatorFieldName,
	    discriminatorFieldName = _ref8$discriminatorFi === undefined ? 'typeName' : _ref8$discriminatorFi;
	...
	var completeSchema = Object.assign({}, swagger, {
		definitions: Object.assign({}, swagger.definitions || {}, {
			Query: {
				...
				properties: (0, _lodash.mapValues)(queriesDescriptions, function (_ref9) {
			...
			Mutation: {
				...
				properties: (0, _lodash.mapValues)(mutationsDescriptions, function (_ref10) {
	...
	[completeSchema.definitions.Query, completeSchema.definitions.Mutation, completeSchema].forEach(function (schema) {
		...
		parseRootInputTypes({ schema: schema, types: types, discriminatorFieldName: discriminatorFieldName });
	});
