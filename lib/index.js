...
var constructOperationArgsAndResolver = function constructOperationArgsAndResolver(apiDefinition, operations, links, propertyName, createResolver, typesCache) {
			...
			typesCache[schemaId] = new _graphql.GraphQLInterfaceType({
				...
				fields: function fields() {
					return Object.keys(properties).reduce(function (acc, propertyName) {
						...
						var _constructOperationAr = constructOperationArgsAndResolver(apiDefinition, operations, links, propertyName, createResolver, typesCache),
			...
			typesCache[schemaId] = new _graphql.GraphQLObjectType({
				...
				fields: function fields() {
					return Object.keys(properties).filter(function (propertyName) {
						...
						var _constructOperationAr2 = constructOperationArgsAndResolver(apiDefinition, operations, links, propertyName, createResolver, typesCache),
